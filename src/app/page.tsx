    ...
    return (
        ...
        md:flex-row md:items-center md:px-[50px] xl:mt-[80px]">
            <CardHeader className="flex items-center p-0 md:mr-[60px]">
                <Avatar className="w-[72px] h-[72px] sm:w-[100px] sm:h-[100px] 
                ...
                <CardDescription className="text-[16px] md:text-center">Full Stack Develop</CardDescription>
            </CardHeader>
            <div className="md:flex-col">
                <CardContent className="text-justify mt-[10px] p-0">
                    ...
                    <p className="text-[#A9A9A9] font-light mb-[35px]">Possuo
                ...
                <CardContent className="p-0">
                    ...
                    <h1 className="font-semibold">🦎 Exception
                    ...
                    <h1 className="font-semibold">🐴 Steed
                        | Jan 2025 - Presente</h1>
